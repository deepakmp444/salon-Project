...
<body class="bg-light">
  ...
  ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h1 class="display-4 text-center">Make Your Business Digitally</h1>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class='col-sm-12'>
        ...
        <p class="text-center ">
          ...
          <a href="#" style="color: black;"><b class="bg-white rounded">Digital Salon</b></a>
        </p>
      </div>
    </div>
  </footer>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle"> Change Profile Setting </h5>
        ...
        <div class="modal-body">
          <form action="#" method="POST" class="needs-validation" novalidate>
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="password" placeholder="You have to Enter password Other Wise Passowrd gone be blank" name="password" required  >
              <div class="valid-feedback">Valid.</div>
            </div>
            <div>
